...
function getContacts(filterBy = null) {
  return new Promise((resolve, reject) => {
    let contactsFromDb =
      localStorageService.loadFromLStorage(CONTACT_KEY) || contacts
    if (filterBy && filterBy.term) {
      contactsToReturn = filter(filterBy.term)
    }
    localStorageService.saveToLStorage(CONTACT_KEY, contactsFromDb)
...
function deleteContact(id) {
  return new Promise((resolve, reject) => {
    ...
    localStorageService.saveToLStorage(CONTACT_KEY, contacts)
    resolve(contacts)
  })
}
...
function getRandomContact() {
  const contacts = localStorageService.loadFromLStorage(CONTACT_KEY)
...
//   name = "Baba",
//   email = "BabaJi@baba.com",
//   phone = "+972 (050) 999-9999"
// ) {
